...
console.log(tyrannosaurus.roar);//THIS ONE NEEDS JUST A LITTLE HELP!//
...
const universities = [];
graduates.forEach(item => {university.push(item.universities)};
...
graduates.forEach(item => {
  emails.push(`${item.name}, ${item.email}`)
});
